...
class feedback extends React.Component {
  ...
  render() {
    return (
      <div className="container feedback__main">
        <div className="row">
        ...
        <div className="feedback__stars row d-flex justify-content-center">
          <ReactStars
            style={{
              width: "300.49px",
              height: "38.48px",
        ...
        <div className="row container">
          <div className="feedback__col1 col-6">
            <div className="feedback__grey">
              <div className="feedback__r1">Wait time</div>
            </div>
            ...
            <div className="feedback__r3 ">
              <div className="feedback__waitButtons d-flex justify-content-start p-0">
                ...
                <a href="#">
                  <button className="feedback__min30">30 min</button>
                </a>

                <a href="#">
                  <button className="feedback__min45">45 min</button>
                </a>

                <a href="#">
                  <button className="feedback__hr1">1 hr</button>
                </a>

                <a href="#">
                  <button className="feedback__hr2">&gt;&gt;1 hr</button>
                </a>
              </div>
            </div>
            <div className="feedback__grey">
              <div className="feedback__r4">Like to Recommend?</div>
            </div>
            <div className="feedback__r5">
              Would you like to recommend Dr. Swapnil to others ?
            </div>
            <div
              onChange={this.recommend.bind(this)}
              className="feedback__radio"
            >
              <input
                className="feedback__radioBtn"
                type="radio"
                value="Yes"
                name="recom"
              />{" "}
            ...
            <div className="feedback__grey">
              <div className="feedback__r6">Feedback and Purpose</div>
            </div>
            ...
            <div className="feedback__grey">
              <div className="feedback__r8">Write your feedback</div>
            </div>
          ...
          <div className="feedback__col2 col-6">
            <div className="feedback__r9">Consult Satisfaction</div>
            <div className="feedback__r10">Your positive consult...</div>
            <div className="feedback__check">
              <div className="form-check">
                <label
                  for="check1"
                  className={
                    this.state.understandingSelected === true
                      ? "feedback__poscheck form-check-label"
                      : " feedback__posuncheck form-check-label"
                  }
                >
                  <input
                    type="checkbox"
                    class="form-check-input feedback__checkbox"
                    id="check1"
                    name="understanding"
              ...
              <div class="form-check">
                <label
                  for="check2"
                  className={
                    this.state.satisfiedSelected === true
                      ? "feedback__poscheck form-check-label"
                      : " feedback__posuncheck form-check-label"
                  }
                >
              ...
              <div class="form-check">
                <label
                  for="check3"
                  className={
                    this.state.politeSelected === true
                      ? "feedback__poscheck form-check-label"
                      : " feedback__posuncheck form-check-label"
                  }
                >
              ...
              <div class="form-check">
                <label
                  for="check4"
                  className={
                    this.state.valueForMoneySelected === true
                      ? "feedback__poscheck form-check-label"
                      : " feedback__posuncheck form-check-label"
                  }
                >
              ...
              <div class="form-check">
                <label
                  for="check5"
                  className={
                    this.state.properGuidanceSelected === true
                      ? "feedback__poscheck form-check-label"
                      : " feedback__posuncheck form-check-label"
                  }
                >
              ...
              <div class="form-check">
                <label
                  for="check6"
                  className={
                    this.state.friendlySelected === true
                      ? "feedback__poscheck form-check-label"
                      : " feedback__posuncheck form-check-label"
                  }
                >
            ...
            <div className="feedback__r11">Your negative consult...</div>
            <div className="feedback__check">
              <div class="form-check">
                <label
                  for="check1"
                  className={
                    this.state.unprofessionalSelected === true
                      ? "feedback__negcheck form-check-label"
                      : " feedback__neguncheck form-check-label"
                  }
                >
                  <input
                    type="checkbox"
              ...
              <div class="form-check">
                <label
                  for="check2"
                  className={
                    this.state.notSatisfiedSelected === true
                      ? "feedback__negcheck form-check-label"
                      : " feedback__neguncheck form-check-label"
                  }
                >
              ...
              <div class="form-check">
                <label
                  for="check3"
                  className={
                    this.state.impoliteStaffSelected === true
                      ? "feedback__negcheck form-check-label"
                      : " feedback__neguncheck form-check-label"
                  }
                >
              ...
              <div class="form-check">
                <label
                  for="check4"
                  className={
                    this.state.languageBarrierSelected === true
                      ? "feedback__negcheck form-check-label"
                      : " feedback__neguncheck form-check-label"
                  }
                >
              ...
              <div class="form-check">
                <label
                  for="check5"
                  className={
                    this.state.noProperGuidanceSelected === true
                      ? "feedback__negcheck form-check-label"
                      : " feedback__neguncheck form-check-label"
                  }
                >
              ...
              <div class="form-check">
                <label
                  for="check6"
                  className={
                    this.state.awkwardSelected === true
                      ? "feedback__negcheck form-check-label"
                      : " feedback__neguncheck form-check-label"
                  }
                >
        ...
        <button type="feedback__button" class="btn btn-secondary">
          Submit Anonymously
        </button>
      </div>
    );
